...
namespace ProEventos.Services.Interfaces
{
    public interface ILotesService
    {
        ...
        Task<ErrorOr<List<LoteDto>>> SaveLotes(int eventoId, List<LoteDto> models, string userId);
        Task<ErrorOr<Success>> DeleteLote(int eventoId, int loteId, string userId);
